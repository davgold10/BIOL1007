...
### long format = contrains values that do repeat in the ID column
...
View(b1) #rmarkdown hates this, remove if knitting!!!
...
table(dryadData$species) # allows you to see diff groups of character column
summary(dryadData$mean.hydro)


## copied and pasted from lecture notes
